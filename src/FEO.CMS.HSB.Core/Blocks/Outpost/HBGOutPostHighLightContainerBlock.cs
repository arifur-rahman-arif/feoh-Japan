...
namespace FEO.CMS.HBG.Core.Blocks.Outpost
{
    ...
    public class HBGOutPostHighLightContainerBlock : HBGBaseBlock
    {
        ...
        [Display(Name = "Title Image", GroupName = "Content", Order = 500)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference TitleImage { get; set; }

        [Display(Name = "Background Image", GroupName = "Content", Order = 600)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference BackgroundImage { get; set; }

        [Display(Name = "SubTitle", GroupName = "Content", Order = 700)]
        [CultureSpecific]
