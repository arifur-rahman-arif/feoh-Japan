...
namespace FEO.CMS.HBG.Core.Blocks.Outpost
{
    ...
    {
        [Display(Name = "Divider Image", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference DividerImage { get; set; }

        [Display(Name = "Tablet Divider Image", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference TabletDividerImage { get; set; }

        [Display(Name = "Mobile Divider Image", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
