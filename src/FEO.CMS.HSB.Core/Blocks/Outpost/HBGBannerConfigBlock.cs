...
namespace FEO.CMS.HBG.Core.Blocks.Outpost
{
    ...
    {
        [Display(Name = "Text Alignment", GroupName = "Settings", Order = 100)]
        [CultureSpecific]
        public virtual ContentReference TextAlignment { get; set; }

        [Display(Name = "Show Gallery", GroupName = "Settings", Order = 200)]
        [CultureSpecific]
        public virtual bool ShowGallery { get; set; }

        [Display(Name = "Font Size", GroupName = "Settings", Order = 300)]
        [CultureSpecific]
        public virtual ContentReference FontSize { get; set; }

        [Display(Name = "Show Downward Arrow", GroupName = "Settings", Order = 400)]
        [CultureSpecific]
        public virtual bool ShowDownwardArrow { get; set; }

        [Display(Name = "Show Pullout Widget", GroupName = "Settings", Order = 500)]
        [CultureSpecific]
        public virtual bool ShowPulloutWidget { get; set; }

        [Display(Name = "Show Sticky Widget", GroupName = "Settings", Order = 600)]
        [CultureSpecific]
        public virtual bool ShowStickyWidget { get; set; }

        [Display(Name = "Show Contacts", GroupName = "Settings", Order = 700)]
        [CultureSpecific]
