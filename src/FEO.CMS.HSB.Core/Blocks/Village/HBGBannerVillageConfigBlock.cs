...
namespace FEO.CMS.HBG.Core.Blocks.Village
{
    ...
    public class HBGBannerVillageConfigBlock : HBGBaseBlock
    {
        ...
        [Display(Name = "Show view gallery button", GroupName = "Settings", Order = 300)]
        [CultureSpecific]
        public virtual bool Showviewgallerybutton { get; set; }

        [Display(Name = "Show Pullout Widget", GroupName = "Settings", Order = 400)]
        [CultureSpecific]
        public virtual bool ShowPulloutWidget { get; set; }

        [Display(Name = "Sticky Widget", GroupName = "Settings", Order = 500)]
        [CultureSpecific]
        public virtual bool StickyWidget { get; set; }

        [Display(Name = "Font Color", GroupName = "Settings", Order = 600)]
        [CultureSpecific]
        public virtual ContentReference FontColor { get; set; }

        [Display(Name = "Background Color Style Names", GroupName = "Settings", Order = 700)]
        [CultureSpecific]
