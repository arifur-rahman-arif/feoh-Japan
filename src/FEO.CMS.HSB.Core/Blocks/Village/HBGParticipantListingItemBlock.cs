...
namespace FEO.CMS.HBG.Core.Blocks.Village
{
    ...
    public class HBGParticipantListingItemBlock : HBGBaseBlock
    {
        ...
        [Display(Name = "First Label", GroupName = "Settings", Order = 600)]
        [CultureSpecific]
        public virtual string FirstLabel { get; set; }

        [Display(Name = "First Label Value", GroupName = "Settings", Order = 700)]
        [CultureSpecific]
        public virtual string FirstLabelValue { get; set; }

        [Display(Name = "First Label Icon", GroupName = "Settings", Order = 800)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference FirstLabelIcon { get; set; }

        [Display(Name = "Second Label", GroupName = "Settings", Order = 900)]
        [CultureSpecific]
        public virtual string SecondLabel { get; set; }

        [Display(Name = "Second Label Value", GroupName = "Settings", Order = 950)]
        [CultureSpecific]
        public virtual string SecondLabelValue { get; set; }

        [Display(Name = "Second Label Icon", GroupName = "Settings", Order = 975)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference SecondLabelIcon { get; set; }

        [Display(Name = "Third Label", GroupName = "Settings", Order = 1000)]
        [CultureSpecific]
        public virtual string ThirdLabel { get; set; }

        [Display(Name = "Third Label Value", GroupName = "Settings", Order = 1200)]
        [CultureSpecific]
        public virtual string ThirdLabelValue { get; set; }

        [Display(Name = "Third Label Icon", GroupName = "Settings", Order = 1250)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference ThirdLabelIcon { get; set; }

        [Display(Name = "Special Offer Description", GroupName = "Settings", Order = 1300)]
        [CultureSpecific]
        public virtual string SpecialOfferDescription { get; set; }

        [Display(Name = "Special Offer Icon", GroupName = "Settings", Order = 1400)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference SpecialOfferIcon { get; set; }

        [Display(Name = "Property", GroupName = "Settings", Order = 1500)]
        [CultureSpecific]
        public virtual ContentReference Property { get; set; }

        [Display(Name = "Preview Images", GroupName = "Settings", Order = 1600)]
        [CultureSpecific]
        public virtual string PreviewImages { get; set; }

        [Display(Name = "Ribbon Text", GroupName = "Settings", Order = 1700)]
        [CultureSpecific]
