...
namespace FEO.CMS.HBG.Core.Blocks.Village
{
    ...
    {
        [Display(Name = "Title", GroupName = "Content", Order = 50)]
        [CultureSpecific]
        public virtual string Title { get; set; }

        [Display(Name = "Access Token", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        public virtual string AccessToken { get; set; }

        [Display(Name = "Number of Images to show", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        public virtual string NumberofImagestoshow { get; set; }

        [Display(Name = "Hash Tag", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        public virtual string HashTag { get; set; }

        [Display(Name = "JuicerData", GroupName = "Content", Order = 400)]
        [CultureSpecific]
