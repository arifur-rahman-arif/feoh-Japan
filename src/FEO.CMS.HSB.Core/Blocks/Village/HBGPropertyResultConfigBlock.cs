...
namespace FEO.CMS.HBG.Core.Blocks.Village
{
    ...
    {
        [Display(Name = "Display Newsletter", GroupName = "Settings", Order = 50)]
        [CultureSpecific]
        public virtual bool DisplayNewsletter { get; set; }

        [Display(Name = "NewsLetter Position", GroupName = "Settings", Order = 100)]
        [CultureSpecific]
        public virtual double NewsLetterPosition { get; set; }

        [Display(Name = "Listing Type", GroupName = "Settings", Order = 200)]
        [CultureSpecific]
