...
namespace FEO.CMS.HBG.Core.Blocks.Village
{
    ...
    {
        [Display(Name = "Divider Color Style Names", GroupName = SystemTabNames.Settings, Order = 200)]
        [CultureSpecific]
        public virtual ContentReference DividerColorStyleNames { get; set; }

        [Display(Name = "IsDividerDisplay", GroupName = SystemTabNames.Settings, Order = 300)]
        [CultureSpecific]
        public virtual bool IsDividerDisplay { get; set; }

        [Display(Name = "Link Color Style Name", GroupName = SystemTabNames.Settings, Order = 400)]
        [CultureSpecific]
