...
namespace FEO.CMS.HBG.Core.Blocks.Bases
{
    ...
    {
        [Display(Name = "Number To Show On Desktop", GroupName = SystemTabNames.Settings, Order = 100)]
        [CultureSpecific]
        public virtual double NumberToShowOnDesktop { get; set; }

        [Display(Name = "Number To Show On Mobile", GroupName = SystemTabNames.Settings, Order = 150)]
        [CultureSpecific]
