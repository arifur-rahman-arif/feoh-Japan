...
namespace FEO.CMS.HBG.Core.Blocks.Bases
{
    ...
    public class HBGEventBaseBlock : HBGBaseBlock
    {
        ...
        [Display(Name = "Gallery", GroupName = "Content", Order = 850)]
        [CultureSpecific]
        public virtual string Gallery { get; set; }

        [Display(Name = "Brochure Download", GroupName = "Content", Order = 1000)]
        [CultureSpecific]
        public virtual LinkItem BrochureDownload { get; set; }

        [Display(Name = "Ribbon Text", GroupName = "Content", Order = 1100)]
        [CultureSpecific]
        public virtual string RibbonText { get; set; }

        [Display(Name = "Enable Enquiry CTA", GroupName = "Content", Order = 1200)]
        [CultureSpecific]
