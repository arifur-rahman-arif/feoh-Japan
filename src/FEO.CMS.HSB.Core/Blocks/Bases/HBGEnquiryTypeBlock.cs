...
namespace FEO.CMS.HBG.Core.Blocks.Bases
{
    ...
    {
        [Display(Name = "Enable Unselect Property - If this field checked, users doesn't need to select any property when user select this enquiry type", GroupName = SystemTabNames.Settings, Order = 100)]
        [CultureSpecific]
