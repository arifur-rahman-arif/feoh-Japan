...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    {
        [Display(Name = "Closing Title", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        public virtual string ClosingTitle { get; set; }

        [Display(Name = "CTA Text", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        public virtual string CTAText { get; set; }

        [Display(Name = "CTA Link", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        public virtual LinkItem CTALink { get; set; }

        [Display(Name = "Mobile CTA Link", GroupName = "Content", Order = 400)]
        [CultureSpecific]
