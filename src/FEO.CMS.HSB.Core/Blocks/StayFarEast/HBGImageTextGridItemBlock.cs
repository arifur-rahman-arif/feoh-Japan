...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    {
        [Display(Name = "USP Category", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        public virtual string USPCategory { get; set; }

        [Display(Name = "Preview Images", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        public virtual string PreviewImages { get; set; }

        [Display(Name = "Image Caption", GroupName = "Content", Order = 300)]
        [CultureSpecific]
