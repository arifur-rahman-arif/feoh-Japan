...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    {
        [Display(Name = "Main Image", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference MainImage { get; set; }

        [Display(Name = "Left Image", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference LeftImage { get; set; }

        [Display(Name = "Middle Image", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference MiddleImage { get; set; }

        [Display(Name = "Right Image", GroupName = "Content", Order = 400)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference RightImage { get; set; }

        [Display(Name = "Room Title", GroupName = "Content", Order = 500)]
        [CultureSpecific]
        public virtual string RoomTitle { get; set; }

        [Display(Name = "Room Description", GroupName = "Content", Order = 600)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString RoomDescription { get; set; }

        [Display(Name = "Room Highlight", GroupName = "Content", Order = 700)]
        [CultureSpecific]
