...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    public class HBGBannerConfigBlock : HBGImageDarknessOverlayConfigBlock
    {
        ...
        [Display(Name = "Show Banner Summary", GroupName = "Settings", Order = 200)]
        [CultureSpecific]
        public virtual bool ShowBannerSummary { get; set; }

        [Display(Name = "Show Banner Title", GroupName = "Settings", Order = 300)]
        [CultureSpecific]
        public virtual bool ShowBannerTitle { get; set; }

        [Display(Name = "Show Current Item Caption", GroupName = "Settings", Order = 400)]
        [CultureSpecific]
        public virtual bool ShowCurrentItemCaption { get; set; }

        [Display(Name = "Show Current Item Title", GroupName = "Settings", Order = 500)]
        [CultureSpecific]
        public virtual bool ShowCurrentItemTitle { get; set; }

        [Display(Name = "Use Description As Summary", GroupName = "Settings", Order = 600)]
        [CultureSpecific]
