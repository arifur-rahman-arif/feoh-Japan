...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    public class HBGNewsListingCarouselItemBlock : HBGBaseBlock
    {
        ...
        [Display(Name = "Label", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        public virtual ContentReference Label { get; set; }

        [Display(Name = "Description", GroupName = "Content", Order = 500)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString Description { get; set; }

        [Display(Name = "Publish Date", GroupName = "Content", Order = 550)]
        [CultureSpecific]
        public virtual DateTime PublishDate { get; set; }

        [Display(Name = "Location", GroupName = "Content", Order = 600)]
        [CultureSpecific]
        public virtual ContentReference Location { get; set; }

        [Display(Name = "CTA Link", GroupName = "Content", Order = 700)]
        [CultureSpecific]
