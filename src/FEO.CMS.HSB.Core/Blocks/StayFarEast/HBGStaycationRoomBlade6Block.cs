...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    {
        [Display(Name = "Blade Banner 1", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference BladeBanner1 { get; set; }

        [Display(Name = "Blade Banner 2", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference BladeBanner2 { get; set; }

        [Display(Name = "Blade Banner 3", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
