...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    {
        [Display(Name = "Amenities Banner", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference AmenitiesBanner { get; set; }

        [Display(Name = "Amenities Name", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        public virtual string AmenitiesName { get; set; }

        [Display(Name = "Amenities Description", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString AmenitiesDescription { get; set; }

        [Display(Name = "Amenities Blurb", GroupName = "Content", Order = 400)]
        [CultureSpecific]
        public virtual string AmenitiesBlurb { get; set; }

        [Display(Name = "Amenities SubName", GroupName = "Content", Order = 500)]
        [CultureSpecific]
