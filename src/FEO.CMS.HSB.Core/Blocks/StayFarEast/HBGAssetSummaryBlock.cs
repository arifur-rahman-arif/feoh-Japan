...
namespace FEO.CMS.HBG.Core.Blocks.StayFarEast
{
    ...
    {
        [Display(Name = "Count", GroupName = SystemTabNames.Content, Order = 100)]
        [CultureSpecific]
        ...
        [Display(Name = "Subject", GroupName = SystemTabNames.Content, Order = 300)]
        [CultureSpecific]
        public virtual string Subject { get; set; }

        [Display(Name = "Link", GroupName = SystemTabNames.Content, Order = 400)]
        [CultureSpecific]
