...
namespace FEO.CMS.HBG.Core.Pages.StayFarEast
{
    ...
    {
        [Display(Name = "Terms Conditions Title", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        public virtual string TermsConditionsTitle { get; set; }

        [Display(Name = "Terms Conditions Content", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString TermsConditionsContent { get; set; }

        [Display(Name = "Form Title", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        public virtual string FormTitle { get; set; }

        [Display(Name = "Form Content", GroupName = "Content", Order = 400)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
