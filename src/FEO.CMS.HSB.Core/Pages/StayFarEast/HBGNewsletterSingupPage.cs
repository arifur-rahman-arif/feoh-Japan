...
namespace FEO.CMS.HBG.Core.Pages.StayFarEast
{
    ...
    {
        [Display(Name = "Footer Text", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString FooterText { get; set; }

        [Display(Name = "Form Parameters", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        public virtual string FormParameters { get; set; }

        [Display(Name = "Form URL", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        public virtual LinkItem FormURL { get; set; }

        [Display(Name = "Header Text", GroupName = "Content", Order = 400)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString HeaderText { get; set; }

        [Display(Name = "Return URL", GroupName = "Content", Order = 500)]
        [CultureSpecific]
        public virtual LinkItem ReturnURL { get; set; }

        [Display(Name = "Error Redirect URL", GroupName = "Content", Order = 600)]
        [CultureSpecific]
