...
namespace FEO.CMS.HBG.Core.Pages.StayFarEast
{
    ...
    {
        [Display(Name = "", GroupName = "Content", Order = 100)]
        [CultureSpecific]
        ...
        [Display(Name = "Size", GroupName = "Content", Order = 200)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString Size { get; set; }

        [Display(Name = "PhoneNumber", GroupName = "Content", Order = 300)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString PhoneNumber { get; set; }

        [Display(Name = "EmailAddress", GroupName = "Content", Order = 400)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString EmailAddress { get; set; }

        [Display(Name = "VenueBrochure", GroupName = "Content", Order = 500)]
        [CultureSpecific]
        [UIHint(UIHint.MediaFile)]
        public virtual ContentReference VenueBrochure { get; set; }

        [Display(Name = "VenueFloorPlan", GroupName = "Content", Order = 600)]
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual ContentReference VenueFloorPlan { get; set; }

        [Display(Name = "VenueFloorPlanPDF", GroupName = "Content", Order = 700)]
        [CultureSpecific]
        [UIHint(UIHint.MediaFile)]
        public virtual ContentReference VenueFloorPlanPDF { get; set; }

        [Display(Name = "VenueInformation", GroupName = "Content", Order = 800)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString VenueInformation { get; set; }

        [Display(Name = "TestimonialsTitle", GroupName = "Content", Order = 900)]
        [CultureSpecific]
        public virtual string TestimonialsTitle { get; set; }

        [Display(Name = "TestimonialsDescription", GroupName = "Content", Order = 1000)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
        public virtual XhtmlString TestimonialsDescription { get; set; }

        [Display(Name = "Find out More", GroupName = "Content", Order = 1100)]
        [CultureSpecific]
        [UIHint(UIHint.Textarea)]
